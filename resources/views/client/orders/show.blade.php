        ...
        <div class="bg-white dark:bg-gray-800 shadow-md rounded p-6">
            ...
            <div class="text-right mt-4">
                ...
                <a href="{{ route('orders.invoice', $order) }}"
                   class="inline-block ml-4 bg-white hover:bg-gray-50 text-gray-800 px-4 py-2 rounded text-sm font-bold border-2 border-indigo-600 hover:border-indigo-700">
